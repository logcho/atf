...
export default function Hero() {
    return (
        <section className="flex flex-col items-center justify-center bg-[url('/images/bg.jpg')] bg-cover bg-center bg-no-repeat h-screen w-full" id="inicio">
            {/* Gradient Overlay */}
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/50 to-transparent" />
            {/* Text Content */}
            <div className="relative p-6 max-w-3xl text-center font-thin">
                <h1
                ...
                <div className="flex flex-col items-center justify-center gap-y-2 mt-2">
                    ...
                    >
                        <Button className="text-black text-md font-extrabold w-80 hover:brightness-110" style={{ background: "#ffce1b" }}>
                    ...
                    <a
                        ...
                        rel="noopener noreferrer"
                    >
                        <Button className="text-white text-md font-extrabold w-80 hover:brightness-110" style={{ color: "#ffce1b" }}>
